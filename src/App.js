...
export default function App() {
  ...
  async function getTransactions() {
    const url = "https://api-money-checker.vercel.app" + "/api/transactions";
  ...
  const addNewTransaction = (e) => {
    ...
    const url = "https://api-money-checker.vercel.app" + "/api/transaction";
  ...
  const deleteTransaction = (id) => {
    const url = "https://api-money-checker.vercel.app" + `/transaction/${id}`;
